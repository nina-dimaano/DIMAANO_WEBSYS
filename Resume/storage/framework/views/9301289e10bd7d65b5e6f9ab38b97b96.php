...
<div class="container">
    <form method="POST" action="<?php echo e(route('resume.update')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="profile-picture-section">
            ...
            <?php if($user->profile_picture): ?>
                <img src="<?php echo e(asset('storage/' . $user->profile_picture)); ?>" alt="Profile Picture" class="profile-preview" id="preview">
            <?php else: ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                    <div style="color: red; font-size: 12px; margin-top: 5px;"><?php echo e($message); ?></div>
                <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <label>Title</label>
        <input type="text" name="title" value="<?php echo e(old('title', $user->title)); ?>">
        ...
        <label>Website</label>
        <input type="text" name="website" value="<?php echo e(old('website', $user->website)); ?>">

        <label>About Me</label>
        <textarea name="about" rows="4"><?php echo e(old('about', $user->about)); ?></textarea>

        <!-- Education -->
        <div class="section">
            <h3>🎓 Education</h3>
            <div id="educationFields">
                <?php $educations = $user->education ?? []; ?>
                ...
                <div class="item-group">
                    ...
                    <label>Type</label>
                    <input type="text" name="education[<?php echo e($index); ?>][type]" value="<?php echo e($edu['type'] ?? ''); ?>">
                    <label>Year</label>
                    <input type="text" name="education[<?php echo e($index); ?>][year]" value="<?php echo e($edu['year'] ?? ''); ?>">
                    <label>School</label>
                    <input type="text" name="education[<?php echo e($index); ?>][school]" value="<?php echo e($edu['school'] ?? ''); ?>">
                </div>
        ...
        <div class="section">
            ...
            <div id="expFields">
                <?php $experiences = $user->experience ?? []; ?>
                ...
                <div class="item-group">
                    ...
                    <input type="text" name="experience[<?php echo e($index); ?>][seminar]" value="<?php echo e($exp['seminar'] ?? ''); ?>">
                    <label>Year</label>
                    <input type="text" name="experience[<?php echo e($index); ?>][year]" value="<?php echo e($exp['year'] ?? ''); ?>">
                    <label>Position</label>
                    <input type="text" name="experience[<?php echo e($index); ?>][position]" value="<?php echo e($exp['position'] ?? ''); ?>">
                    <label>Tasks (comma-separated)</label>
                    <input type="text" name="experience[<?php echo e($index); ?>][tasks]" value="<?php echo e(is_array($exp['tasks'] ?? null) ? implode(', ', $exp['tasks']) : ($exp['tasks'] ?? '')); ?>">
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        ...
        <div class="section">
            ...
            <div id="skillsFields">
                ...
                <div class="item-group">
                    ...
                    <input type="text" name="skills[<?php echo e($index); ?>][name]" value="<?php echo e($skill['name'] ?? ''); ?>">
                    <label>Proficiency (1-5)</label>
                    <select name="skills[<?php echo e($index); ?>][level]">
                        <?php for($i = 1; $i <= 5; $i++): ?>
                            <option value="<?php echo e($i); ?>" <?php echo e(($skill['level'] ?? 0) == $i ? 'selected' : ''); ?>><?php echo e($i); ?></option>
                        <?php endfor; ?>
                    </select>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="form-actions">
            ...
            <a href="<?php echo e(route('resume.public', $user->id)); ?>" target="_blank" class="view-btn">🌐 View Public Resume</a>
        </div>
    </form>
</div>
...
let eduIndex = <?php echo e($eduCount); ?>;
let expIndex = <?php echo e($expCount); ?>;
let skillIndex = <?php echo e($skillCount); ?>;
...
</html><?php /**PATH C:\Users\Nina Rica\OneDrive\Desktop\resume-system\resources\views/resume_edit.blade.php ENDPATH**/ ?>